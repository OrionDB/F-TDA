			...
			<div class="content">
			  ...
			  <!-- Start First List 1 columns -->
				  ...
				  <dl>
					...
					<dd class="newsHome">Je suis Orion, chef et fondateur de la team, je suis également Amiral du CDF.<br><br>
					...
					<dd class="newsHome">Bonjours, suite à la sortie de notre nouveau forum, nous relançons les campagnes de recrutement, par conséquent, si vous vous sentez l'âme de contribuer activement à la vie de la team, n'hésiter pas à passer faire un tour dans la section "Recrutement" du forum "Candidature" pour
						 ...
						 Cordialement le Commandement</dd>
						 
					<dt>Avis de promotion</dt>
					<dd class="newsHome">Bonjours, j'ai le plaisir de vous annoncez que T'Pel à été promue au poste de numéro deux de la team.<br><br>
						 Cordialement Orion</dd>
